...
class LinksController extends Controller
{
    ...
    {
         return view('myorders.admin.index');
    }
    ...
    {   
        ...
        $users=User::where('status','=','1')->paginate(10);
         return view('myorders.admin.users')->with('users', $users);
    }
    public function show_user_role_edit_view($id)
    {
        $userroles=User::find($id);
        return view('myorders.admin.edituserrole')->with('userroles', $userroles);
    }
    ...
    public function products()
    {
        $Products=Products::where('status','!=','2')->paginate(5);
         return view('myorders.admin.Products.index')->with('Products', $Products);
    }
    public function show_add_product_screen()
    {
        return view('myorders.admin.Products.add');
    ...
    public function recycleproducts()
    {
        $Products=Products::where('status','=','2')->paginate(10);
         return view('myorders.admin.Products.bin')->with('Products', $Products);
    }

    public function     showorders()
    {
        return view('myorders.admin.orders');
    }
    public function     showTransactions()
    {
        return view('myorders.admin.Transactions');
    }
     public function     showNewsLetter()
    {
        $NewsLetter=NewsLetter::select('email','name')->distinct('name')->paginate(10);
        return view('myorders.admin.NewsLetter')->with('NewsLetter', $NewsLetter);
    }
